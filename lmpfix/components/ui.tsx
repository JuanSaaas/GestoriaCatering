...
export const inputCls =
  ...
  'focus:outline-none focus:border-black focus:ring-2 focus:ring-black/10 transition disabled:bg-neutral-50';
export const labelCls = 'flex items-center gap-1.5 text-xs font-medium text-neutral-500 mb-1.5';
export const btnPrimary =
  'inline-flex items-center justify-center gap-1.5 h-9 px-4 rounded-lg bg-black text-white text-sm font-medium ' +
  'shadow-sm hover:bg-neutral-800 transition disabled:opacity-60 disabled:cursor-not-allowed';
