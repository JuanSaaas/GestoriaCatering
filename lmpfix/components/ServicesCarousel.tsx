...
export default function ServicesCarousel() {
  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 pt-16 md:pt-20 pb-8">
      ...
      <div className="relative min-h-[78vh] md:min-h-[85vh] overflow-hidden bg-ink">
        {SERVICIOS.map((s, i) => (
          <div
            key={s.n}
        ...
        <div className="relative z-10 min-h-[78vh] md:min-h-[85vh] flex items-end md:items-center">
